...
exports.localNodeURL = '127.0.0.1:8000/api/loader/status/sync'; // If you want to use for testing "https://node04.lisk.io/api/loader/status/sync" or use your node in testnet, don't forget the port 7000
...
exports.remoteNodes = [ //nodes to check for the block heights
  {
